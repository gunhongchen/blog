const croute = [
    ...
    },
    {
        ...
        children: [
            { path: '', name: 'c-album', component: () => import(/* webpackChunkName: "c-album" */ '../views/console/album/C-album.vue') },
        ]
    },
    {
        path: 'tags',
        ...
        children: [
            { path: '', name: 'tags', component: () => import(/* webpackChunkName: "c-tags" */ '../views/console/tags/C-tags.vue') },
