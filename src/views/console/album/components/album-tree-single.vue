        ...
        <div class="overflow-hidden mb-20">
            <div class="float-left">
                <div class="inline-block" v-if="fileData.type=='FOLDER'">
                    <i class="el-icon-folder color-3 cursor-pointer" v-if="opened.indexOf(fileData._id)==-1" @click="openFolder(fileData)"></i>
                    <i class="el-icon-folder-opened color-3 cursor-pointer" v-if="opened.indexOf(fileData._id)>-1" @click="closeFolder(fileData)"></i>
                </div>
